...
module.exports.signup = function (username, email, password, status, callback) {
  con.query("call addUser(?,?,?,?)",[username,email,password,status],function(err,result){
    if (err) {
        console.log("err:", err);
    } else {
...
module.exports.verify = function (username, email, token, callback) {
  con.query("call generateToken(?,?,?)",[username,email,token],function(err,result){
    if (err) {
        console.log("err:", err);
    } else {
        console.log("results:", result);
...
module.exports.add_doctor = function (
  ...
  con.query("call addDoctor(?,?,?,?,?,?,?,?,?,?)",[first_name,last_name,email,dob,gender,address,phone,image,department,biography],function(err,result){
    if (err) {
        console.log("err:", err);
    } else {
        console.log("results:", result);
...
module.exports.getappointmentbyid = function (id, callback) {
  var query = "call get_all_apointments("+id+")";
  console.log(query);
  con.query(query, callback);
};
